...
function Header() {
	...
	function handleClick(item) {
		if (!sessionStorage.getItem("ids")) {
			...
			handleShow();
		} else if (!sessionStorage.getItem("anomalyData") && item === "/dashboard") {
					...
					>
						...
						<Offcanvas.Body>
							<Nav className="justify-content-end flex-grow-1 pe-3 align-items-start">
								...
								<Button as={ Nav.Link } variant="link" href="/" className="light-text menu-route-options" onClick={ handleClickLogOut }>
