					...
					>
						...
						<Offcanvas.Body>
							<Nav className="justify-content-end flex-grow-1 pe-3 align-items-start">
								<Button as={ Nav.Link } variant="link" className="light-text menu-route-options" onClick={ () => handleClick("/TableroDeAnomalias/dashboard") }>Dashboard</Button >
								<Button as={ Nav.Link } variant="link" className="light-text menu-route-options" onClick={ () => handleClick("/TableroDeAnomalias/upload") }>Upload</Button>
